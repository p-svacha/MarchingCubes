...
public class Hash
{
    ...
    private int NumRepeats; // How many each value occurs in the array, used for more randomness (values get bigger and are then modulo'd)
    ...
    public Hash(RandomNumberGenerator rng, int numValues, int numRepeats = 256)
    {
        // Initialize
        NumValues = numValues;
